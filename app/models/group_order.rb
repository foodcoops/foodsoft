      ...
      order_articles.each do |order_article|
        ...
        data[:order_articles][order_article.id] = {
          ...
          quantity_available: (if order.stockit?
                                 ...
                                 order_article.article_version.convert_quantity(
                                   [order_article.article_version.maximum_order_quantity - order_article.quantity + goa.quantity, 0].max, order_article.article_version.supplier_order_unit, order_article.article_version.group_order_unit
                                 )
                               end)
        }
      end
