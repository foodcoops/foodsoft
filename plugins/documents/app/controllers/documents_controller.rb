...
class DocumentsController < ApplicationController
  ...
  def create
    @document = Document.new params[:document].slice(:name, :parent_id)
    ...
    @document.save!
    redirect_to @document.parent, notice: t('.notice')
  rescue => error
    redirect_to @document.parent, alert: t('.error', error: error.message)
  end
