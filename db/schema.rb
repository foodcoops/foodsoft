...
ActiveRecord::Schema.define(version: 20200718074332) do
  ...
  create_table "assignments", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["task_id"], name: "fk_rails_b7c53ee3b6", using: :btree
  ...
  create_table "bank_transactions", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["bank_account_id"], name: "fk_rails_e0117c6727", using: :btree
  ...
  create_table "deliveries", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["invoice_id"], name: "fk_rails_c9bbe97b0f", using: :btree
  ...
  create_table "documents", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "updated_at"
    t.integer  "parent_id"
    t.index ["created_by_user_id"], name: "fk_rails_7294a1aa59", using: :btree
  ...
  create_table "financial_transaction_types", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["financial_transaction_class_id"], name: "fk_rails_f2b646cddc", using: :btree
  ...
  create_table "financial_transactions", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["financial_link_id"], name: "fk_rails_d41d3fdfae", using: :btree
    t.index ["financial_transaction_type_id"], name: "fk_rails_dba6d95fbf", using: :btree
    t.index ["group_order_id"], name: "fk_rails_88ae0ba39c", using: :btree
    ...
    t.index ["user_id"], name: "fk_rails_0cbb08eeee", using: :btree
  end
  ...
  create_table "group_orders", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["updated_by_user_id"], name: "fk_rails_1889c54304", using: :btree
  end
  ...
  create_table "invites", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["group_id"], name: "fk_rails_9e216f1ff4", using: :btree
    t.index ["token"], name: "index_invites_on_token", using: :btree
    t.index ["user_id"], name: "fk_rails_ff69dbb2ac", using: :btree
  end
  ...
  create_table "invoices", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.integer  "financial_link_id"
    t.index ["created_by_user_id"], name: "fk_rails_8fd25eeb3c", using: :btree
    t.index ["financial_link_id"], name: "fk_rails_75b0aafe67", using: :btree
  ...
  create_table "messages", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["reply_to"], name: "fk_rails_3730b06fab", using: :btree
  ...
  create_table "order_articles", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["article_id"], name: "fk_rails_44e6c21781", using: :btree
    t.index ["article_price_id"], name: "fk_rails_798fa38c22", using: :btree
  ...
  create_table "order_comments", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["user_id"], name: "fk_rails_9db67cf94d", using: :btree
  end
  ...
  create_table "orders", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.decimal  "transport",                        precision: 8, scale: 2
    t.index ["created_by_user_id"], name: "fk_rails_30144627f8", using: :btree
    t.index ["invoice_id"], name: "fk_rails_b33ed6c672", using: :btree
    t.index ["state"], name: "index_orders_on_state", using: :btree
    t.index ["supplier_id"], name: "fk_rails_d426350910", using: :btree
    t.index ["updated_by_user_id"], name: "fk_rails_f3fe5911c4", using: :btree
  end
  ...
  create_table "page_versions", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["parent_id"], name: "fk_rails_966d369f50", using: :btree
  end
  ...
  create_table "pages", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["parent_id"], name: "fk_rails_409bbac70a", using: :btree
  ...
  create_table "poll_votes", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["ordergroup_id"], name: "fk_rails_931f43cfec", using: :btree
    ...
    t.index ["user_id"], name: "fk_rails_b64de9b025", using: :btree
  end
  ...
  create_table "polls", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["created_by_user_id"], name: "fk_rails_ddedb38d1d", using: :btree
  ...
  create_table "printer_jobs", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["created_by_user_id"], name: "fk_rails_a222b5a8b4", using: :btree
    t.index ["finished_at"], name: "index_printer_jobs_on_finished_at", using: :btree
    t.index ["finished_by_user_id"], name: "fk_rails_c259d78e0a", using: :btree
    t.index ["order_id"], name: "fk_rails_f691a1be68", using: :btree
  end
  ...
  create_table "stock_changes", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["order_id"], name: "fk_rails_6ddf028707", using: :btree
  ...
  create_table "supplier_categories", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.string  "description"
    t.integer "financial_transaction_class_id", null: false
    t.index ["financial_transaction_class_id"], name: "fk_rails_e4db9d9002", using: :btree
  end
  ...
  create_table "suppliers", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.index ["shared_supplier_id"], name: "fk_rails_6958f49bbb", using: :btree
    t.index ["supplier_category_id"], name: "fk_rails_f8fa27fa1f", using: :btree
  end
  ...
  create_table "tasks", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.integer  "created_by_user_id"
    t.index ["created_by_user_id"], name: "fk_rails_1f562c7b99", using: :btree
    t.index ["due_date"], name: "index_tasks_on_due_date", using: :btree
    t.index ["name"], name: "index_tasks_on_name", using: :btree
    t.index ["periodic_task_group_id"], name: "fk_rails_78a5d11f82", using: :btree
