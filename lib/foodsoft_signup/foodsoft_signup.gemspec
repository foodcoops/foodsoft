...
Gem::Specification.new do |s|
  ...
  s.description = "This plugin allows prospective members to create their a new foodsoft account (and ordergroup). Only when their ordergroup is approved by an administrator, can they order (this is configurable)."
