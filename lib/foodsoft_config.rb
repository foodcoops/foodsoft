  ...
  class << self
    ...
    def initial_default_config
      cfg = {
        ...
        oidc_enabled: false,
        oidc_button_label: "Login with Single Sign-On",
        oidc_client_id: nil,
        oidc_client_secret: nil,
        oidc_issuer: nil,
        oidc_authorization_endpoint: nil,
        oidc_token_endpoint: nil,
        oidc_jwks_uri: nil,
        oidc_auto_create_user: false,
        oidc_groups_claim: "groups",
        oidc_auto_create_ordergroup: false,
        oidc_default_ordergroup: nil,
        oidc_sync_groups_strictly: false,
